...
import {
  ...
  CheckCircle2, Activity, Landmark, Sparkles, Info
} from 'lucide-react';

import { useNavigation } from '../contexts/NavigationContext';
import { formatCurrency } from '../utils/formatters';

// Componentes Principais da Pasta Components
import DashboardCards from './DashboardCards';
import ForecastWidget from './ForecastWidget';
import TransactionForm from '../features/transactions/TransactionForm';

// Nossos Novos Componentes Fatiados
import { calcStatus, MONO } from '../utils/dashboardUtils';
...
const containerVariants = {
  ...
  visible: {
    opacity: 1,
    transition: {
      staggerChildren: 0.15, // Atraso entre a entrada de cada componente
      delayChildren: 0.1
    }
  }
};
...
const itemVariants = {
  ...
  visible: {
    opacity: 1,
    y: 0,
    transition: { type: 'spring', stiffness: 80, damping: 15 } // Física de Mola (suave)
  }
};
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap items-baseline gap-3 mb-3">
                <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter font-mono">
                  {/* React CountUp para rolar os números do Saldo */}
                  <CountUp 
                    end={saldo} 
                    duration={2} 
                    separator="." 
