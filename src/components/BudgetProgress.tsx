      ...
      <div className="relative z-10">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 gap-4">
          <div className="flex items-center gap-3">
            <div className={`p-2.5 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/5 shadow-sm dark:shadow-none ${textColor} transition-colors`}><Icon className="w-5 h-5" /></div>
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">{monthlyGoal > 0 ? 'Monitorização ativa do seu orçamento.' : 'Defina uma meta para ativar a IA.'}</p>
            </div>
          </div>
