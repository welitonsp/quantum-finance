...
export const transactionSchema = z.object({
  ...
  value:       z.number().int().positive('O valor deve ser positivo'),
  type:        z.enum(['entrada', 'saida'], { error: "O tipo tem de ser 'entrada' ou 'saida'" }),
...
export const toCentavos = (val: string | number | null | undefined): number => {
