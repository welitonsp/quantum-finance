 ...
 * saldo − compromissos fixos mensais ainda não registrados neste mês − fatura corrente.
 */
export function useSpendingPower({
  ...
  return useMemo(() => {
    ...
    const available = (saldoCents - pendingCommitmentsCents - cardInvoiceCents) as Centavos;
