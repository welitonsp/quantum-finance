...
| 2 | **F-13 — cobertura risk-based** — PR #443 (27 pure-logic) ✅ + hooks Firebase (41 testes, #444) ✅ + `processResolvedImportBatch`/`importCandidateSearch` (31 testes) ✅. Resta apenas: `src/components/**` via RTL (última fatia). | Ext. F-13 | testes | 🔄 parcial |
